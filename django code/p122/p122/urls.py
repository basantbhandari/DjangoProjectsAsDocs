...
urlpatterns = [
    ...
    path('create/', views.StudentCreateView.as_view(), name='createform'),
    ...
    path('updatethanks/',
         views.updateThanksTemplateView.as_view(),
         name='updatethanks'),
    path('deletethanks/',
         views.deleteThanksTemplateView.as_view(),
         name='deletethanks'),
]